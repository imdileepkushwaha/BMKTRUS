﻿<%@ page language="C#" autoeventwireup="true" inherits="RegistrationNew, App_Web_5j543tp4" %>
        ...
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-sm-3 py-2 px-sm-2 px-1">
                ...
                <div id="logo" style="text-align:center">
                     <h1><a href="index.html"><img src="assets/img/logo/logo.png" width="150"></a></h1>
                       <div class="text-center"> <h4 style="color:#0fa047"><b>Success Money Mantra</b></h4>
            </div>
                </div>
                <!-- //logo -->
                <!-- nav -->
