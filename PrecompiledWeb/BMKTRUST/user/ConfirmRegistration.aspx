<%@ page language="C#" autoeventwireup="true" inherits="user_ConfirmRegistration, App_Web_jenbvmkc" %>
...
Welcome To  <%= clsUtility.ProjectName %>, Dear  <span style="font-size:35px; color:#ee7509"><asp:Label ID="lblName" runat="server"></asp:Label> <asp:Label ID="lblLastname" runat="server"></asp:Label></span><br>You are now registered with <%= clsUtility.ProjectName %>, Your User Id is <span style="font-family:arial black;font-size:35px;color:#ee7509;"><b><asp:Label ID="LblLoginId" runat="server"> </asp:Label></b></span><br>
