<%@ page title="Withdrawl Request" language="C#" masterpagefile="masterpage.master" autoeventwireup="true" inherits="user_WithdrawlRequstAdd, App_Web_l32qxuo3" %>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>Enter Amount :</label>
                                   <asp:TextBox ID="txtamount"    runat="server" onkeypress="return isNumberKey(event);" CssClass="form-control" OnTextChanged="txtamount_TextChanged" AutoPostBack="true" />
                             </div>
                         </div>
                     </div>
                       <div class="row">
