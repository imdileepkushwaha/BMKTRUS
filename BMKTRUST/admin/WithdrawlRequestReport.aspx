                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable"
                                        ...
                                        EmptyDataText="No withdrawal requests found for the selected criteria.">
                                        <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sponser Name">
                                        <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnApprove" CommandName="approve" OnClick="btnApprove_click" runat="server" CssClass="btn btn-primary btn-xs">Approve</asp:LinkButton>
                                                    <asp:LinkButton ID="btnReject" CommandName="reject" OnClick="btnReject_click" runat="server" CssClass="btn btn-danger btn-xs">Reject</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
