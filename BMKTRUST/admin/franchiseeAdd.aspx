                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtSponsorId" CssClass="form-control" runat="server" AutoPostBack="True" OnTextChanged="txtSponsorId_TextChanged" placeholder="Sponsor user ID"></asp:TextBox>
                                            <span class="adm-field-hint">Name loads after sponsor ID is entered</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtOutletName" runat="server" CssClass="form-control" placeholder="Shop / outlet name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>PAN No.</label>
                                            <asp:TextBox ID="txtPANNo" runat="server" CssClass="form-control" placeholder="ABCDE1234F"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Pincode</label>
                                            <asp:TextBox ID="txtpincode" onkeypress="return isNumber(event)" CssClass="form-control" runat="server" placeholder="6-digit pincode"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
