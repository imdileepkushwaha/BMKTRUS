<%@ Page Title="Level Income Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserLevelIncomeReport.aspx.cs" Inherits="admin_UserLevelIncomeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Level Income Report</li>
        </ol>
    </section>
</asp:Content>
            ...
            <div class="adm-util-page">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Level Income List</h3>
                            </div>
                            <div class="box-body">
