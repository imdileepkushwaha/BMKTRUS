<%@ Page Title="Daily Level Income Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserDailyLevelIncomeReport.aspx.cs" Inherits="admin_UserDailyLevelIncomeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Daily Level Income Report</h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Income Reports</a></li>
            <li class="active">Daily Level Income Report</li>
        </ol>
    </section>
</asp:Content>
            ...
            <div class="adm-util-page">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Level Income List</h3>
                            </div>
                            <div class="box-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable"
                                        ...
                                        EmptyDataText="No daily level income records found.">
                                        <Columns>
