<%@ Page Title="Direct Income Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserDirectIncomeReport.aspx.cs" Inherits="admin_UserDirectIncomeReport" %>
            ...
            <div class="adm-util-page">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Direct Income List</h3>
                            </div>
                            <div class="box-body">
