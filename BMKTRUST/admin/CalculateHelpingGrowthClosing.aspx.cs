...
public partial class admin_CalculateHelpingGrowthClosing : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        bool ok = RunClosing("sp_GenerateHelpingLevelIncomePool2", fromDate, toDate);
        Alert(ok ? "Growth Closing completed successfully." : "Growth Closing failed. Please try again.");
    }
