<%@ Page Title="E-Pin Request Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="PinRequestReport.aspx.cs" Inherits="admin_PinRequestReport" %>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="adm-field-hint">Leave blank to include all members</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable"
                                        Width="100%" AutoGenerateColumns="False" OnRowDataBound="grdGetHelp_RowDataBound"
                                        OnRowCommand="GridView1_RowCommand" GridLines="None"
                                        EmptyDataText="No E-Pin requests found for the selected criteria.">
                                        <Columns>
