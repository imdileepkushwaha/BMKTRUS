<%@ Page Title="Weekly Payout" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="PaidJoiningClosingMonthly.aspx.cs" Inherits="JoiningClosingReportMonthly"  EnableEventValidation="false" %>
              ...
              <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="box box-primary wp-search">
                        ...
                        <div class="box-footer">
                            ...
                            <asp:Button ID="BtnMessage" CssClass="btn btn-info" runat="server" Text="Message" OnClick="BtnMessage_Click" />
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="box box-primary wp-list">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-list-alt"></i> Payout Details</h3>                           
                              <div style="float: right">
                        <asp:LinkButton ID="ImageButton1" runat="server" ToolTip="Download Excel" CssClass="bmk-excel-btn" OnClick="ExportToExcel" aria-label="Download Excel"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26" fill="currentColor" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8.89 17h1.61l.95-1.92L12.4 17h1.61l-1.72-3.05L14.1 11h-1.66l-.88 1.86L10.7 11H9.08l1.72 2.95L8.89 17z"/></svg></asp:LinkButton></div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <Columns>
                                   ...
                                   <%--  <asp:TemplateField HeaderText="Binary Income" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblLevelincome" runat="server" CssClass="wp-amt" Text='<%#Eval("Levelincome", "{0:0.00}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Referral Bonus">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDirect" runat="server" CssClass="wp-amt" Text='<%#Eval("DirectIncome", "{0:0.00}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Self Purchase Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSelfPurchase" runat="server" Text='<%#Eval("SelfPurchaseIncomee") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                          <asp:TemplateField HeaderText="Matching Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblbinaryincome" runat="server" Text='<%#Eval("matchingincomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Leadership Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLeadership" runat="server" Text='<%#Eval("leadershipincomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Director Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDirector" runat="server" Text='<%#Eval("directorincomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Gold Director Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGold" runat="server" Text='<%#Eval("golddirectorincomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Crown Director Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCrown" runat="server" Text='<%#Eval("crowndirectorIncomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                     
                                      <asp:TemplateField HeaderText="Platinum Director Incomee" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPlatinum" runat="server" Text='<%#Eval("platinumdirectorIncomee") %>'></asp:Label>
                                        </ItemTemplate>
                                               </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Diamond Director Incomee" Visible="false">
                                        <ItemTemplate>
