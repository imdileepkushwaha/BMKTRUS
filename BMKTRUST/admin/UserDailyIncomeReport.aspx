<%@ Page Title="Daily Income Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserDailyIncomeReport.aspx.cs" Inherits="admin_UserDailyIncomeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Daily Income Report</li>
        </ol>
    </section>
</asp:Content>
            ...
            <div class="adm-util-page">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Income List</h3>
                            </div>
                            <div class="box-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable"
                                        ...
                                        EmptyDataText="No daily income records found.">
                                        <Columns>
