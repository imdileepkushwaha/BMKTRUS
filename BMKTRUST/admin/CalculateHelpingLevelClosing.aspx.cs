...
public partial class admin_CalculateHelpingLevelClosing : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        bool ok = RunClosing("sp_GenerateHelpingLevelIncome", fromDate, toDate);
        Alert(ok ? "Level Closing completed successfully." : "Level Closing failed. Please try again.");
    }
