<%@ Page Title="Referral Bonus Report" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ReferralBonusReport.aspx.cs" Inherits="user_ReferralBonusReport" %>
    ...
    <div class="bmk-panel">
        <div class="bmk-profile-hero">
            <div class="bmk-profile-hero-text">
                ...
                <p class="bmk-crumb"><a href="Dashboard.aspx">Dashboard</a> &nbsp;/&nbsp; My Income &nbsp;/&nbsp; Referral Bonus Report</p>
            </div>
        </div>
    </div>
</asp:Content>
