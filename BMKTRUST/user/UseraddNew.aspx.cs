...
public partial class user_UseraddNew : System.Web.UI.Page
{
 ...
 btnSubmit.Enabled = true;
                ...
                loadsusername();
                txtparentid.Text = Session["UserId"].ToString();
                loadParentname();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        else if (RdBtnRight.Checked == true)
        {
            objUser.StandingPosition = "2";
        }
        else
        {
            objUser.StandingPosition = "3";
        }
        objUser.UserName = txtname.Text;
        objUser.Height = txtage.Text;
        objUser.Mobile = txtmobile.Text;
        objUser.AdhaarNo = txtadhar.Text;
        objUser.Email = txtemail.Text;
        objUser.Gender = ddgender.SelectedValue.ToString();
        objUser.AreaName = DropDowncourse.SelectedValue.ToString();
        //objUser.telegramname = txttelegramname.Text;
        //objUser.telegramnumber = txttelegramnumber.Text;
        ...
        // objUser.USerLastName = txtLastname.Text;
        ...
        //  objUser.EpinNo = txtepin.Text;
        string res = Insert_User(objUser, txtLastname.Text, txttelegramname.Text, txttelegramnumber.Text);
        if (res == "ext")
        {
        ...
        {
            string popupScript = "alert('this Leg is already used');";
            ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), popupScript, true);
        }
        ...
        else
        {
            ...
            //    Session["UserNameLastname2"] = dt.Rows[0]["UserName"].ToString();//dt.Rows[0]["Surname"].ToString();
            ...
            //    string TransPassword = txtuserpassword.Text;
    ...
    public string Insert_User(clsUser objUser, string lastname,string telegramnumber,string telegramname)
    {
        string res = "";
        string s2 = "";
        SqlConnection cn;
        ...
        try
        {
            ...
            SqlParameter[] parameter = {
                    ...
                    new SqlParameter("@ParentUserId",objUser.ParentUserId),
                    ...
                    new SqlParameter("@Gender",objUser.Gender),
                     new SqlParameter("@course",objUser.AreaName),
                       new SqlParameter("@telegramnumber",telegramnumber),
                         new SqlParameter("@telegramname",telegramname),
    ...
    {
        string str_query = @"SELECT ud.AadharNo,ud.userid,ud.SponserId, (Select Username from UserDetail where UserId=ud.SponserId) as SponserName,ud.username,ud.mobile,ud.Address, 
    ...
    void loadepinamount()
    {
        ...
        DataTable dt = new DataTable();
        dt = getEPinFullDetail(objepin);
        if (dt.Rows.Count > 0)
        {
            txtamount.Text = dt.Rows[0]["amount"].ToString();
        }
        else
        {    Message.Show("Wrong Epin");
            txtamount.Text = "";
			 txtepin.Text = "";
			// string popupScript = "alert('Invalid Epin');";
        ...
        {
            string str_query = "select * from EPinMaster where  epinno = '" + objEPin.EPinNo + "' and Epinstatus = 'Active' ";
