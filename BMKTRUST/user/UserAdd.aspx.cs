...
public partial class admin_UserAdd : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        objUser.NomDateOfBirth = ddlDay.SelectedValue.ToString() + "/" + ddlMonth.SelectedItem.ToString() + "/" + ddlYear.SelectedItem.ToString();
       ...
       // objmail.MailData("1224", "srivastavadevesh05@gmail.com");
        ...
        if (res == "-1")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Session["UserNameLastname2"] = dt.Rows[0]["Surname"].ToString();
