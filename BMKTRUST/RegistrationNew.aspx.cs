...
public partial class RegistrationNew : System.Web.UI.Page
{
            ...
            if (Request.QueryString["UserId"] != null)
            {
               ...
               // loadepinamount();
                ...
                if (Request.QueryString["standingposition"] != null)
                {
                    ...
                    else if (Request.QueryString["standingposition"].ToString() == "2")
                    {
                        RdBtnRight.Checked = true;
                    }
                    else
                    {
                        RdbtnLast.Checked = true;
                    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
     ...
     //   objUser.AreaName = txtareaname.Text;
       // objUser.USerLastName = txtLastname.Text;
        ...
        //  objUser.EpinNo = txtepin.Text;
        string res = Insert_User(objUser, txtLastname.Text);
        if (res == "ext")
        {
    ...
    public string Insert_User(clsUser objUser,string lastname)
    {
        string res = "";
        string s2 = "";
        SqlConnection cn;
            ...
            SqlParameter[] parameter = {
                    ...
                    new SqlParameter("@Gender",objUser.Gender),
                     new SqlParameter("@course",objUser.AreaName),
                       new SqlParameter("@telegramnumber",objUser.telegramnumber),
                         new SqlParameter("@telegramname",objUser.telegramname),
